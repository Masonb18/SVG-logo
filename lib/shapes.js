...
class Square {
    ...
    render() {
        return `<svg xmlns="http://www.w3.org/2000/svg" height="200" width="300"><rect x="10" y="10" width="30" height="30" fill="${this.color}"/><text x="150" y="125" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.text}</text></svg>`
